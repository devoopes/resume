...
* Create project plan and manage resources in re-architecture of AWS infrastructure into containers. 
* Move all infrastructure into ECS with new Terraform and Circle CI pipelines
* Work with the engineering team leads to train on re-platforming to containers. 
...
* Work with HR to deploy new technology on-boarding plan.
